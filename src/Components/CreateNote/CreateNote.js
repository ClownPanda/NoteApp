...
const CreateNote = () => {
  ...
  useEffect(() => {
    function handleOutsideClick(event) {
      if (noteBtnClick && popupRef.current && !popupRef.current.contains(event.target)) {
        setNoteBtnClick(false);
      }
    }
  ...
  return (
    <div className="container-body" style={{ display: displayContainer }}>
      <div className="create-note-container flex" ref={popupRef}>
        ...
        {nameError && <p className="show-error">*Please Enter your group name</p>}
